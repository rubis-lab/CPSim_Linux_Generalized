...
void ScheduleSimulator::busy_period_analysis(JobVectorsForEachECU& job_vectors_for_each_ECU, std::vector<std::shared_ptr<Job>>& job_queue, int busy_start, int& busy_end, int ecu_id, bool is_best)
{
