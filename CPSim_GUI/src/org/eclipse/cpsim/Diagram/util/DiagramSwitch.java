...
public class DiagramSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case DiagramPackage.DUAL: {
			Dual dual = (Dual) theEObject;
			T result = caseDual(dual);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
	 ...
	 * '<em>CAN</em>'. <!-- begin-user-doc --> This implementation returns null;
	...
	/**
	 * Returns the result of interpreting the object as an instance of
	 * '<em>ECU</em>'. <!-- begin-user-doc --> This implementation returns null;
	 * returning a non-null result will terminate the switch. <!-- end-user-doc -->
	 * 
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of
	...
	/**
	 * Returns the result of interpreting the object as an instance of
	 * '<em>SWC</em>'. <!-- begin-user-doc --> This implementation returns null;
	 * returning a non-null result will terminate the switch. <!-- end-user-doc -->
	 * 
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of
	...
	/**
	 * Returns the result of interpreting the object as an instance of
	 * '<em>Dual</em>'. <!-- begin-user-doc --> This implementation returns null;
	 * returning a non-null result will terminate the switch. <!-- end-user-doc -->
	 * 
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of
